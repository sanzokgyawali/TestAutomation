...
namespace Accounts.Data.AccountModels
{
    public partial class AbpUsers
    {
        public AbpUsers()
        {
            ...
            TimesheetsApprovedByUser = new HashSet<Timesheets>();
            TimesheetsCreatorUser = new HashSet<Timesheets>();
            TimesheetsInvoiceGeneratedByUser = new HashSet<Timesheets>();
        }
        ...
        public virtual ICollection<Timesheets> TimesheetsApprovedByUser { get; set; }
        public virtual ICollection<Timesheets> TimesheetsCreatorUser { get; set; }
        public virtual ICollection<Timesheets> TimesheetsInvoiceGeneratedByUser { get; set; }
    }
}
